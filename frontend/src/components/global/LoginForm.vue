<template>
    <div class="flex flex-col items-center p-4 mx-4 my-auto bg-white rounded shadow">
        <div class="flex flex-col items-center py-6 mb-3">
            <h1 class="text-3xl font-bold">Project Manager</h1>
            <h2 class="text-lg font-semibold text-blue-500">
                <span v-if="type == 'login'">Sign in to continue</span>
                <span v-if="type == 'register'">Sign up to continue</span>
            </h2>
        </div>
        <form @submit="login" class="flex flex-col items-center mt-4">
            ...
            <TextButton type="submit" text="Login" color="blue" class="w-full mt-4">
                <span v-if="type == 'login'">Sign in</span>
                <span v-if="type == 'register'">Sign up</span>
            </TextButton>
            ...
            <div class="mt-4">
                <a href="#" class="text-blue-500">
                    <span v-if="type == 'login'">Don't have an account? Sign up</span>
                    <span v-if="type == 'register'">Already have an account? Sign in</span>
                </a>
            </div>
        </form>
    </div>
